...
class UserControllerTests {
    ...
    void testGetUsersByAgeOrder() {
        ...
        when(userService.getUsersByAgeOrder(Sort.Direction.ASC)).thenReturn(users);

        ResponseEntity<List<User>> response = userController.getUsersByAgeOrder(Sort.Direction.ASC);
    ...
    void testGetUsersByFilter() {
        ...
        User users = users().getFirst();
        when(userService.getUsersByFilter(filterName, filterValue)).thenReturn(users);

        ResponseEntity<User> response = userController.getUsersByFilter(filterName, filterValue);
